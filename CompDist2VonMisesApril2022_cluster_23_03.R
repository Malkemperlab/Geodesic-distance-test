...
source("/gpfs/soma_fs/home/malkemper/R/Scripts/Functions_Feb2023_for_publication.R") # only works like this if the functions are in the working directory, otherwise change path to working directory 
options("scipen" = 10)
enableJIT(3)

#setting sample size for dist 1 - in two steps to reduce typing effort
nvseq=c(10,20,50,20,10,30,50)
nv1=c(nvseq,nvseq,nvseq) 

#setting sample size for dist 2
nvseq2=c(10,20,50,30,50,20,10)
